...
export default function BackgroundHero() {
  ...
  return (
    <div 
      ref={containerRef}
      className="absolute inset-0 w-full h-full overflow-hidden hero-spline-container"
      style={{ 
        zIndex: 0,
    ...
    >
      ...
      {/* Subtle dark tint overlay - reduced for better visibility */}
      <div 
        className="absolute inset-0 bg-black/10 pointer-events-none"
        style={{ zIndex: 1 }}
      />
      
      {/* Hide Spline watermark - ONLY for hero background - AGGRESSIVE */}
      <style>{`
