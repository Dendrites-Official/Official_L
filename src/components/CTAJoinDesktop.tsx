...
export default function CTAJoinDesktop({
  ...
  return (
    <section className="cta-desktop-outer">
      <div className="cta-desktop-frame">
        <Spline
          scene={SCENE_URL}
          onLoad={handleLoad}
          onError={handleError}
          className="cta-desktop-spline"
        />

        {/* Whole hero is the CTA */}
        <a
          href={ctaHref}
          target="_blank"
          rel="noopener noreferrer"
          aria-label={ctaLabel}
          className="cta-desktop-overlay"
          onClick={() =>
            console.log("[CTAJoinDesktop] Overlay clicked →", ctaHref)
          }
        />

        <div className="cta-desktop-bottom-gradient" aria-hidden="true" />
      </div>
