...
export default function CTAJoinMobile({ ctaHref = "https://waitlist.dendrites.ai/", ctaLabel = "Join the Waitlist", }) {
    const splineRef = useRef(null);
    // Zoom the Spline camera based on viewport width & aspect ratio
    const applyZoomForViewport = useCallback((app) => {
    ...
    return (_jsxs("section", { className: "cta-mobile-outer", children: [_jsx(Spline, { scene: SCENE_URL, onLoad: handleLoad, onError: handleError, className: "cta-mobile-spline" }), _jsx("a", { href: ctaHref, target: "_blank", rel: "noopener noreferrer", "aria-label": ctaLabel, className: "cta-mobile-overlay", onClick: () => console.log("[CTAJoinMobile] Overlay clicked →", ctaHref) }), _jsx("style", { children: `
        /* =========================================
