...
export default function MobileSRL({ sceneUrl = "https://prod.spline.design/Ma21i9Ulbjz29I-M/scene.splinecode", }) {
    ...
    return (_jsxs("section", { className: "mobile-srl-outer", children: [_jsx("div", { className: "mobile-srl-inner", children: _jsxs("div", { className: "mobile-srl-box", children: [_jsx("div", { className: "mobile-srl-frame", children: _jsx(Spline, { scene: sceneUrl, onLoad: handleLoad, onError: handleError, className: "mobile-srl-spline" }) }), _jsx("div", { className: "mobile-srl-bottom-gradient" })] }) }), _jsx("style", { children: `
        /* ===============================
