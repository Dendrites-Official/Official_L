...
export interface KnowledgeEntry {
  keywords: string[];
  response: string;
  category: 'general' | 'technical' | 'tokenomics' | 'vision' | 'commerce' | 'roadmap';
}
...
export const KNOWLEDGE_BASE: KnowledgeEntry[] = [
  ...
  // WHAT IS DNDX
  {
    ...
    response: "Dendrites (ticker: DNDX) is a commerce-grade crypto payment protocol focused on Predictable Gas™, UNDO refunds, escrow, and safer on-chain commerce. We solve unpredictable gas fees, irreversible payments, fraud/scams, and cross-chain friction. Key features: Predictable Gas™ (stable flat-quote fees in USDC), QuickPay (instant card-swipe-style payments), APP Escrow (milestone-based with refunds), SafetySend/UNDO (short refund window), and the SRL L2 vision for service-level receipts and safe-commerce guarantees.",
    category: 'general'
  },
  ...
  // ROADMAP
  {
    keywords: ['roadmap', 'timeline', 'launch', 'when', 'release date', 'milestones', 'status', 'stage'],
    response: "We're currently in the Demo & Design phase: public interactive demos are live, smart-contract architecture and protocol design are under heavy iteration. Next phases: Pre-Testnet Build (implement on-chain versions of Predictable Gas, QuickPay, SafetySend, APP Escrow), Public Testnets (user testing + Season-0 airdrop/points), Presale-1 & Ecosystem Kickoff (compliant presale via Reg S/Reg D 506(c)), Mainnet Launch (core payment stack), Listing & Liquidity (DEX + strategic venues), and SRL L2 & Advanced R&D (long-term). Check our Roadmap page for details.",
    category: 'roadmap'
  },
  ...
  // EXCHANGE LISTINGS
  {
    keywords: ['exchange', 'listing', 'buy dndx', 'where to buy', 'trade', 'listed'],
    response: "DNDX is not yet listed. We're in the demo/build phase, with testnets and presales planned. Only trust announcements from our official channels (website, X, Discord, email list). Initial listing is planned on a DEX like Uniswap on Ethereum with controlled float and responsible liquidity.",
    category: 'tokenomics'
  },
  ...
  // KYC & COMPLIANCE
  {
    keywords: ['kyc', 'compliance', 'regulation', 'legal', 'license', 'security', 'is this legal'],
    response: "We're working with legal counsel and following frameworks like Reg S (non-US) and Reg D 506(c) (accredited US investors), but this is not legal or investment advice. Please consult your own advisor for your situation. Our BVI entity (already incorporated) will act as the token issuer; Delaware entity (in progress) focuses on R&D and IP. We're preparing patent filings for key parts of the SRL L2/Predictable Gas/safe-commerce architecture.",
    category: 'general'
  },
...
export const SUPPORT_FALLBACK = 
  "That's a great question! For detailed technical support or complex inquiries, please contact our team at support@dendrites.ai - we'll get back to you within 24 hours with a comprehensive answer.";
...
export function findBestMatch(userQuery: string): string {
