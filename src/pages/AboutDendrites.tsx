// src/pages/AboutDendrites.tsx
import React, { useEffect } from "react";
import Footer from "@/components/Footer";

export default function AboutDendrites() {
  useEffect(() => {
    document.title =
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
        ...
        <section id="predictable-gas" className="mb-12">
          ...
          <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-3">
            Most on-chain payments feel like a guess. You approve a transaction
            and hope the network isn&apos;t congested, the gas price doesn&apos;t
            spike and the final cost matches what you saw in the UI. Dendrites
            introduces <span className="text-white">Predictable Gas™</span>, a
            model where fees are surfaced up front in stable terms so merchants
            and users know what they&apos;re paying before they commit.
          </p>
          <p className="text-sm sm:text-base text-white/70 leading-relaxed">
            The goal is to make crypto payments feel as reliable as modern SaaS
            billing: clear costs, fewer surprises and flows that can be embedded
            into real products without constantly worrying about gas volatility.
          </p>
        </section>
        ...
        <section id="safetysend-undo" className="mb-12">
          ...
          <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-3">
            On most chains, a wrong address or typo means funds are gone
            forever. Dendrites introduces{" "}
            <span className="text-white">SafetySend</span>, an UNDO-style
            protection window for supported flows. Instead of a one-way push, a
            transaction can be placed into a protected state for a short period,
            allowing the sender or platform to cancel if something looks off.
          </p>
          <p className="text-sm sm:text-base text-white/70 leading-relaxed">
            This doesn&apos;t rewrite the L1 rules – it wraps payments in a
            programmable layer that handles intent, confirmation and dispute
            logic before final settlement, giving users more confidence when
            sending meaningful amounts on-chain.
          </p>
        </section>
        ...
        <section id="escrow-srl" className="mb-12">
          ...
          <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-3">
            Many &quot;escrow&quot; flows today still live in chats, emails and
            screenshots. Dendrites moves that logic into a{" "}
            <span className="text-white">Stamp Receipt Layer (SRL)</span>,
            where both parties agree to the terms of a payment before funds
            move. Milestones, unlock conditions and dispute paths can be encoded
        ...
        <section id="season-0" className="mb-12">
          ...
          <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-3">
            ...
            running <span className="text-white">Season-0</span> — an
            invite-only phase where participants can earn DNDX allocations and
            collectibles by completing quests, integrating flows and helping us
            harden the product.
          </p>
          <p className="text-sm sm:text-base text-white/70 leading-relaxed">
            ...
            Season-0 activity across quests and integrations, offering claimable
            rewards for the top cohort once this phase closes.
          </p>
        </section>
